...
export function ProcurementForm() {
  ...
  useEffect(() => {
    ...
    const updatedCharges = {
      ...
      colorSorting: {
        ...
        amount: formData.charges.colorSorting.kgs * formData.charges.colorSorting.rate
      },
      hulling: {
  ...
  }, [formData.charges.grading.kgs, formData.charges.colorSorting.kgs, formData.charges.hulling.kgs]);

  const handleOutputChange = (index: number, field: keyof OutputRow, value: number) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.rdnoNumber || !formData.clientName || !formData.clientEmail) {
      toast.error('Please fill in all required fields');
      return;
    }

    // Calculate total weight from outputs
    const totalOutputWeight = formData.outputs.reduce((sum, output) => sum + output.weight, 0);
    const weightDifference = Math.abs(totalOutputWeight - formData.totalCoffeeIn);
    
    if (weightDifference > 1) { // Allow for small rounding differences
      toast.error(`Total output weight (${totalOutputWeight} KGS) does not match total coffee in (${formData.totalCoffeeIn} KGS)`);
      return;
    }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div>
          ...
          <input
            ...
            onChange={(e) => setFormData({ ...formData, rdnoNumber: e.target.value })}
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setFormData({ ...formData, totalCoffeeIn: Number(e.target.value) })}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#4A2C2A]"
            required
            min="0"
          />
        ...
        <div>
          ...
          >
            ...
            <option value="Grading, Color Sorting">Grading, Color Sorting</option>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Weight (KGS)</th>
                ...
                <tr key={output.category}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <input
                      type="number"
                      value={output.bags}
                      onChange={(e) => handleOutputChange(index, 'bags', Number(e.target.value))}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <input
                      type="number"
                      value={output.weight}
                      onChange={(e) => handleOutputChange(index, 'weight', Number(e.target.value))}
                      className="w-24 px-2 py-1 border border-gray-300 rounded-md"
                      min="0"
                    />
                  </td>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">KGS</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              <tr>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Grading</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="number"
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">C/S</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="number"
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Hulling</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="number"
              ...
              <tr className="bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                  {formData.charges.grading.amount + formData.charges.colorSorting.amount + formData.charges.hulling.amount}
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div>
          ...
          <input
            ...
            onChange={(e) => setFormData({
              ...formData,
              signatures: { ...formData.signatures, receivedBy: e.target.value }
            })}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#4A2C2A]"
            required
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setFormData({
              ...formData,
              signatures: { ...formData.signatures, coffeeSortedBy: e.target.value }
            })}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#4A2C2A]"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setFormData({
              ...formData,
              signatures: { ...formData.signatures, gradedBy: e.target.value }
            })}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#4A2C2A]"
          />
        </div>
