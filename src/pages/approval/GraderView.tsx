...
//     state.getItemsByStatus("received"),
//     state.updateStatus,
//   ]);
//   const [isModalOpen, setIsModalOpen] = useState(false);
//   const [selectedItem, setSelectedItem] = useState<any>(null);
//   // const handleGrade = (id: string, currentSignature: string) => {
//   //   const notes = prompt("Add grading notes:") || "";
//   //   updateStatus(id, "graded", currentSignature, notes);
//   // };
//   const handleGrade = (id: string, notes: string) => {
//     updateStatus(id, 'graded', '', notes); // Use empty string for currentSignature or provide as needed
...
//                         <button
//                           onClick={() =>
//                             handleGrade(item.id, item.signatures.gradedBy)
//                           }
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {items.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <button
                          onClick={() => handleGrade(item)} // Pass the full item
                          className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-[#4A2C2A] hover:bg-[#3a2220] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4A2C2A]"
                        >
                          <Eye className="w-4 h-4 mr-2" />
                          Complete Grading
